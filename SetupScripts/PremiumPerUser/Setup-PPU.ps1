...
$SampleModelURL = "https://github.com/kerski/pbi-dataops-template/blob/part16/Pbi/SampleModel/SampleModel.pbix?raw=true"
$SampleModelCDURL = "https://github.com/kerski/pbi-dataops-template/blob/part16/SetupScripts/Pbi/SchemaExample.pbix?raw=true"
$SampleModelCD2URL = "https://github.com/kerski/pbi-dataops-template/blob/part16/SetupScripts/Pbi/SchemaExample.pbix?raw=true"
...
$ProjectResult = az devops project create `
                --name $ProjectName `
                --description "Part 16 example of Bringing DataOps to Power BI" `
...
$PipelineResult = az pipelines create --name $PipelineName --repository-type "tfsgit" `
                --description "Part 16 example pipeline of Bringing DataOps to Power BI" `
                --org "$($AzDOHostURL)$($LogInfo.name)" `
                --project $ProjectName `
